...
//======================================================================
	...
	else
	{
     ...
     trajectory_sub= node_.subscribe<std_msgs::Float32MultiArray>("trajectory", 1, boost::bind(&DrRobotPlayerNode::get_trajectory, this, _1));
...
//======================================================================
void get_trajectory(const std_msgs::Float32MultiArray::ConstPtr& msg){
